...
import type { PaginationParams, WithCount } from '@infra/database/repository';

import { DbAppointment, Appointment, UpdateAppointmentActionDto, CreateAppointmentActionDto } from './types';
import { User } from '../user/types';
import PacientRepository from '../pacient/repository';
import { DbPacient, Pacient } from '../pacient/types';
